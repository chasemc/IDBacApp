  ...
  fluidPage(
    ...
    sidebarPanel(
      ...
      wellPanel(
        ...
        bsCollapse(
          id = "proteinPeakSettingsDropDown",
          open = "Panel 1",
          bsCollapsePanel(
            title = div(
              p("Choose How Peaks Are Retained For Analyses", align = "center"),
      ...
      wellPanel(
        ...
        bsCollapse(
          id = "optionalProteinPeakSettingsDropDown",
          bsCollapsePanel(
            p("Adjust The Dendrogram",
              align = "center"
            ),
            ...
            div(
              ...
              radioButtons("dendOrPhylo",
                ...
                choices = list(
                  "Plot all labels at x = 0" = "Dendrogram",
          ...
          bsCollapsePanel(
            p("Insert Samples From Another Experiment",
              align = "center"
            ),
    ...
    mainPanel(
      tabsetPanel(
        type = "tabs",
        tabPanel(
          value = "proteinMirror", "Mirror Plots",
        ...
        tabPanel(
          value = "proteinDendrogram", "Dendrogram",
