...
# shinycssloaders was copied from: https://cran.r-project.org/web/packages/shinycssloaders/index.html
...
")
    ...
    if (type==5) {
      base_css <- paste(readLines(system.file(file.path("www","cssloader","css-loaders","css","load5.css"),package="IDBacApp")),collapse=" ")
