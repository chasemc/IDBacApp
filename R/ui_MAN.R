  ...
  fluidPage(
    sidebarLayout(
      sidebarPanel(
        ...
        style = "padding:30px",
        bsCollapse(
          id = "collapseManSettings",
          open = "Panel 1",
          bsCollapsePanel(
            p("Show/Hide MAN Settings",
              align = "center"
            ),
            div(
              align = "center",
      ...
      mainPanel(
        ...
        absolutePanel(
          ...
          tabsetPanel(
            type = "tabs",
            tabPanel(
              value = "protd", "Protein Dendrogram",
        ...
        absolutePanel(
          ...
          tabsetPanel(
            type = "tabs",
            tabPanel(
              value = "smallMolMANUI", "Small Molecule MAN",
            ...
            tabPanel(
              value = "smallMolPCAUi", "Small Molecule PCA",
              plotly::plotlyOutput("smallMolPcaPlot")
            ),
            tabPanel(
              value = "smallMirror", "Small Molecule Mirror Plot",
