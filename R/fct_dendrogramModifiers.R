    ...
    if (colorBy == "none") {
      ...
      dendrogram <- tryCatch(
        dendFunc(
          dend = dendrogram,
          h = cutHeight,
          col = as.vector(colorBlindPalette[seq_along(unique(dendextend::cutree(dendrogram, h = cutHeight)))])
        ),
      ...
      dendrogram <- tryCatch(
        dendFunc(
          ...
          col = as.vector(colorBlindPalette[seq_along(unique(dendextend::cutree(dendrogram, k = chosenK)))])
        ),
